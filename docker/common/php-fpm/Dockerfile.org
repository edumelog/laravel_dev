...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    libicu-dev \
    libzip-dev \
    # INÍCIO: Adicione aqui as dependências do sistema para SQL Server
    # unixodbc-dev
    # gnupg2
    # etc...
    # FIM: Dependências do sistema para SQL Server
    ...
    bcmath \
    soap \
    # INÍCIO: Adicione aqui as extensões PHP para SQL Server
    # sqlsrv
    # pdo_sqlsrv
    # FIM: Extensões PHP para SQL Server
    && pecl install redis \
